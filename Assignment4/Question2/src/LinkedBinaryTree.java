...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
    ...
    //------------------------------------------------------------------------
    // Helper method which performs an inorder traversal on an arraylist rather 
    // than an unordered list
    //------------------------------------------------------------------------
    public void inOrderToArrayList(BinaryTreeNode<T> node, ArrayList<T> list) 
    {
        if (node != null) 
        {
            inOrderToArrayList(node.getLeft(), list);
            list.add(node.getElement());
            inOrderToArrayList(node.getRight(), list);
        }
    }
